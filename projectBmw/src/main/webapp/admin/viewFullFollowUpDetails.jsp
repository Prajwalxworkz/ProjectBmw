...
<div class="text-center">
    <p class="h3" style="color: orange">${getFollowUpDetailsErrorMsg}</p>
</div>
 <div class="table-responsive">
   <table class="table table-success table-striped border-dark table-bordered caption-top align-middle ">
     <caption style="color:#000;"><h3>Follow up Details</h3></caption>
    ...
    <tbody>
      <c:forEach items="${followUpDto}" var="dto" varStatus="status">
        <tr>
