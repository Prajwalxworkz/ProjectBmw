...
<div class="container my-5 blur-container">
 <div class="table-responsive">
   <table class="table table-success table-striped border-dark table-bordered caption-top align-middle ">
     <caption style="color:#000;"><h3>List of customers</h3></caption>
      <span class="text-end">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <li><a class="dropdown-item" href="filter?sort=Booking">Booking</a></li>
                  <li><a class="dropdown-item" href="filter?sort=Test_Ride">Test ride</a></li>
              </div>
             </span>
    ...
    <tbody>
      ...
      <!--   <td>${customer.getEmail()}</td>
         <td>${customer.getDto()}</td> -->
         <td>${customer.getAddress()}</td>
         <td>${customer.getDrivingLicense()}</td>
         <td>${customer.getSchedule()}</td>
         <td>${customer.getDateAndTime()}</td>
         <td>${customer.getBranchName()}</td>
         <td>${customer.getModelName()}</td>
         <td  >
            <a class="btn btn-sm btn-light"  href="edit?id=${customer.getId()}"><strong>Edit</strong></a> </br> </br>
           <a  class="btn btn-sm btn-light"  href="view?id=${customer.getId()}"><strong>View</strong></a>
         </td>
        </tr>
      </c:forEach>
    </tbody>
