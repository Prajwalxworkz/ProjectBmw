...
<head>
  ...
  <style>
body{
    background-image: url(<%=request.getContextPath()%>/resources/images/bikeToBranchBg.webp);
...
<body>
  ...
  <div class="container my-5 blur-container">
    <form action="bikeToBranch" method="post">
      <div class="row justify-content-center">
        <div class="col-md-4">
         ...
         <div class="mb-3">
           <select class="form-select" name="bikeId">
                <option selected value="">Bike</option>
                <c:forEach items="${bikeList}" var="bike">
                    <option  value="${bike.getId()}">${bike.getModelName()}</option>
                 </c:forEach>
           </select>
         </div>
